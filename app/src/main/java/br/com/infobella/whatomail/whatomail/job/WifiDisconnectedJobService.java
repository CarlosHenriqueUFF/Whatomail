...
public class WifiDisconnectedJobService extends JobService {

    public WifiDisconnectedJobService() {
        super();
    }

    @Override
    public boolean onStartJob(JobParameters params) {
        LogUtils.writeLog(this, LogUtils.TAG_RECEIVER, "WifiDisconnectedJobService onStart");
        ...
        builder.setTicker(KeyUtils.KEY_ACTION_PENDIND_INTENT_NET_OFF);
